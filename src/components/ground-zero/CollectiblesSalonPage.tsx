...
export function CollectiblesSalonPage() {
  ...
  const openConcierge = (title: string, category = "Curated Collectibles") => {
  ...
  const submitDispatch = (event: FormEvent<HTMLFormElement>) => {
    ...
    if (!mandate) return;
    setDispatchNote("Opening WhatsApp with your acquisition brief.");
    openWhatsApp(
      `Hello PSM Infinity Concierge, I would like to inquire about the allocation: "${mandate}" in Curated Collectibles.`,
    );
